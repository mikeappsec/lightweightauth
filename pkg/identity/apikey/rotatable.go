...
// oracle in subtle.ConstantTimeCompare (KR1).
...
// fixed 32-byte digest at load time for timing-safe comparison (KR1).
...
func (rs *rotatableStore) Lookup(presented string) (entry, bool) {
	...
	// oracle (KR1). Early return is acceptable: each comparison is the
